...
export function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 w-full z-50 bg-black before:content-[''] before:absolute before:left-0 before:right-0 before:bg-black before:bottom-full before:h-[200px]" style={{ WebkitBackfaceVisibility: 'hidden', paddingTop: 'env(safe-area-inset-top)' }}>
